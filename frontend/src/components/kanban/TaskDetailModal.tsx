...
const TaskDetailModal = ({ task, onClose }: TaskDetailModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden flex flex-col transform transition-all duration-300 scale-100"
      ...
      >
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-gray-50">
          <div className="space-y-5">
            ...
            {/* Title */}
            <div className="bg-white rounded-lg px-5 py-4 border border-gray-200 shadow-sm">
            ...
            <div className="bg-white rounded-lg px-5 py-4 border border-gray-200 shadow-sm">
              ...
              <p className="text-base text-gray-900 font-mono font-semibold pl-11 bg-gray-50 px-3 py-2 rounded border border-gray-200 inline-block">
                {task.taskcode}
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg px-5 py-4 border border-gray-200 shadow-sm">
              ...
              <p className="text-sm text-gray-700 leading-relaxed pl-11 whitespace-pre-wrap bg-gray-50 px-4 py-3 rounded border border-gray-200 min-h-[60px]">
